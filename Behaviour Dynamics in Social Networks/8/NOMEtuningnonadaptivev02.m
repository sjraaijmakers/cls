function RMSE = NOMEtuningnonadaptivev02(P)
...
timepoints=[2 5 8 11 14 17 20 23 26 30];
stateselection=[2 4 7 12];
empirical_data = [0.96	0.89	0.85	0.82	0.78	0.76	0.73	0.71	0.69	0.67
0.79	0.76	0.74	0.73	0.72	0.71	0.71	0.7	0.69	0.68
0.59	0.67	0.67	0.67	0.67	0.66	0.65	0.66	0.65	0.65
0.13	0.26	0.28	0.29	0.29	0.3	0.31	0.32	0.32	0.33
];
...
function saveRMSE(RMSE, P)
    ...
    if(~exist(filename,'file'))
        ...
        dlmwrite("hallo.xls",RMSE,'-append')
end
